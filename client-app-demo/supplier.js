...
const walletPath = path.join(__dirname, 'supplier-wallet');
const userId = 'user2';
const adminUserId = 'supplieradmin';
const adminUserPass = 'supplieradminpw';
...
const buildCCPSupplier = () => {
	// load the common connection configuration file
	const ccpPath = path.resolve(__dirname, '..', 'organizations', 'peerOrganizations', 'supplier.ssc-hhm.com', 'connection-supplier.json');
...
async function main() {
    ...
    try {
        const ccp = buildCCPSupplier();

        const caClient = buildCAClient(FabricCAServices, ccp, 'ca.supplier.ssc-hhm.com');
